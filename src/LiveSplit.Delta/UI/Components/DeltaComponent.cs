...
public class DeltaComponent : IComponent
{
    ...
    public void Update(IInvalidator invalidator, LiveSplitState state, float width, float height, LayoutMode mode)
    {
        ...
        bool isComparisonBestSplitTimes = comparisonName.Contains(BestSplitTimesComparisonGenerator.ComparisonName);
        ...
        string bestPaceText = "";
        if (shouldUseBestPaceEver && !Settings.OverrideText)
        {
        ...
        else
        {
            ...
            {
                InternalComponent.AlternateNameText.Clear();
                InternalComponent.AlternateNameText.Add(shouldUseBestPaceEver ? "Best Pace?" + bestPaceText : CompositeComparisons.GetShortComparisonName(comparison));
            }
        }
